        ...
        try {
            ...
            SUPUNMDInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = 'NEDIYA MINI-𝐌𝐃=' + stringSession;  // Prepend your name to the session ID
